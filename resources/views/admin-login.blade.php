@extends('layouts.main', [
    'title' => 'Login Admin - Belle Cosmetics and Beauty Equipment Supplier',
])
...
@section('content')
    <div class="h-screen md:flex">
        <div
            ...
            <div>
                <h1 class="text-white font-bold text-4xl">Belle</h1>
                <p class="text-white mt-1">Cosmetic and Beauty Equipment Suppliers</p>
        ...
        <div class="flex w-2/3 px-20 justify-center py-10 items-center bg-white">
            <form method="POST" action="{{ route('admin.login') }}" class="bg-white w-full">
                @csrf
                <h1 class="text-gray-800 font-bold text-2xl mb-1">Selamat Datang di Panel Admin Belle!</h1>
                <p class="text-sm font-normal text-gray-600 mb-7">Masuk ke dashboard dan panel admin untuk melakukan
                    manajemen data produk pada website!</p>
