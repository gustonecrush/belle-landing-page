@extends('layouts.dashboard', [
    'title' => 'Manajemen Data Produk - Belle Cosmetics and Beauty Equipment Suppliers',
])
    ...
    <div class="flex flex-col gap-10">
        <div class="flex justify-between items-center mb-6">
            <div class="flex flex-col ">
                <h1 class="text-2xl font-semibold">💄 Manajemen Data Produk</h1>
                <p class="text-gray-400 text-sm max-w-md">
                    Lakukan manajemen data produk Belle.
                </p>
            </div>
                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 w-full">
                            <label for="id_category"
                                class="block mb-2 font-medium text-gray-500 dark:text-white text-sm">Category</label>
                        ...
                        <div class="mb-4 w-full">
                            <label for="description"
                                class="block mb-2 font-medium text-gray-500 dark:text-white text-sm">Description
                            </label>
                            <textarea id="description" name="description"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:border-primary focus:outline-primary focus:ring-primary dark:text-white"></textarea>
                            @error('description')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
